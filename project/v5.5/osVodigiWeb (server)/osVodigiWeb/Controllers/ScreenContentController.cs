...
namespace osVodigiWeb.Controllers
{
    public class ScreenContentController : Controller
    {
        ...
        public ScreenContentController() : this(new EntityScreenContentRepository()) 
        { }
        ...
        private List<SelectListItem> BuildVideoList(int currentvideoid)
        {
            ...
            IEnumerable<Video> vids = vidrep.GetActiveVideos(accountid);
        ...
        private List<SelectListItem> BuildSlideShowList(int currentslideshowid)
        {
            ...
            IEnumerable<SlideShow> sss = ssrep.GetActiveSlideShows(accountid);
        ...
        private List<SelectListItem> BuildPlayListList(int currentplaylistid)
        {
            ...
            IEnumerable<PlayList> pls = plrep.GetActivePlayLists(accountid);
