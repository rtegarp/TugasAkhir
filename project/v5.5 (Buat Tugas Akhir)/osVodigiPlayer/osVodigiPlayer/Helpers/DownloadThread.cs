...
namespace TugasAkhirClient
{
    class DownloadThread
    {
        ...
        private int downloadCheckDelayInSecs = 1200;

        public void DownloadThreadWorker()
        {
            try
            {
                downloadDelayInSecs = Convert.ToInt32(ConfigurationManager.AppSettings["DownloadDelayInSecs"]);
                downloadCheckDelayInSecs = Convert.ToInt32(ConfigurationManager.AppSettings["DownloadCheckDelayInSecs"]);
        ...
        private void GetFilesToDownload()
        {
            try
            {
                TugasAkhirClient.osVodigiWS.osVodigiServiceSoapClient ws = new osVodigiWS.osVodigiServiceSoapClient();
